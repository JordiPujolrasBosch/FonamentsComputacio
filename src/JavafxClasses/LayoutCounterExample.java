...
public class LayoutCounterExample implements Layout{
    ...
    public Pane build(){
        ...
        buttonBox.getChildren().addAll(length, inputNumber, loadFileA, loadFileB, apply);
    ...
    private void buildElements(){
        title.setText("Counterexample cfg & cfg");
    ...
    private void buildInteractions(){
        ...
        apply.setOnAction(event -> {
            ...
            else textFieldUnder.setText(call.call(textAreaLeft.getText(), textAreaRight.getText()));
        });
    }
    ...
    private void buildCall(){
        call = (a, b) -> {
            try{
                ...
                return Menu.findCounterExampleCfg(aa,bb,null,null, Integer.parseInt(inputNumber.getText()));
            }
            catch (Exception ex){
