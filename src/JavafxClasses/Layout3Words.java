...
public class Layout3Words {
    ...
    public Layout3Words(String title, String description, String left, String right, String under, CallMenuTwo call){
        this.title = title;
    ...
    private HBox buildButtons(){
        ...
        choiceBox.getItems().add(Utility.defaultString);
        choiceBox.getItems().add(Utility.retYes);
        choiceBox.getItems().add(Utility.retNo);
        choiceBox.setValue(Utility.defaultString);
        ...
        apply.setOnAction(event -> {
            if(choiceBox.getValue().equals(Utility.defaultString)) Utility.setInt(0);
            else if(choiceBox.getValue().equals(Utility.retYes)) Utility.setInt(1);
            else Utility.setInt(2);
            textAreaUnder.setText(call.call(textAreaLeft.getText(), textAreaRight.getText()));
        });

        layout.getChildren().addAll(choiceBox, loadA, loadB, apply);
        return layout;
    }
